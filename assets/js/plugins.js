	...
	$.extend(Plugin.prototype, {
		...
		initSlideshow: function () {
			...
			if (this.support) {
				...
				setTimeout(function(){
					$firstSlide.css( { 'opacity': 1.0, 'transform': 'scale(1.2, 1.2)', 'z-index': 2 } );
				}, 50);
			}
		...
		initSingle: function() {
			...
			if (this.support) {
				...
				setTimeout(function(){
					$slide.css( { 'opacity': 1.0, 'transform': 'scale(1.2, 1.2)', 'z-index': 2 } );
				}, 50);
			}
		},
		...
		jump: function( pos ) {
			...
			if ( this.support ) {
				...
				$nowSlide.addClass('active')
					...
					.css( { 'opacity': 1.0, 'transform': 'scale(1.2, 1.2)', 'z-index': 2 } )
